  ...
  <li><a href="Logout">Logout</a></li>
        ...
        <%
           Class.forName("com.mysql.jdbc.Driver");
            ...
            PreparedStatement pst=con.prepareStatement("select U_ID,MP_Name,MP_DOB,MP_State,MP_DOM,MP_ReportDate from missingpeople_details where MP_Accept=1 and not EXISTS(select F_Reason from found_missingpeople where found_missingpeople.U_ID=missingpeople_details.U_ID)");
            ResultSet rs = pst.executeQuery();
            while(rs.next())
            {
              pst = con.prepareStatement("select ngo_id, AcceptDate from accept_missing where user_id=?");
              pst.setString(1,rs.getString("U_ID"));
              ResultSet r = pst.executeQuery();
              r.next();
              pst = con.prepareStatement("select N_Name from ngo_details where N_ID=?");
              pst.setString(1,r.getString("ngo_id"));
        ...
        %>
           <tr>
            ...
            <tr>
                ...
                <td rowspan=8>
                    <image src="${pageContext.request.contextPath}/DisplayImages?id=<%=rs.getString("U_ID") %>" alt="hii" style="height:220px; width: 220px"/>
                </td>
            </tr>
            <tr>
                <td>
