...
.header {
  ...
  <li><a href="Logout">Logout</a></li>
            ...
            PreparedStatement pst=con.prepareStatement("select U_ID,MP_Name,MP_DOB,MP_State,MP_DOM,MP_ReportDate from missingpeople_details where MP_Accept=0 and not EXISTS(select F_Reason from found_missingpeople where found_missingpeople.U_ID=missingpeople_details.U_ID)");
